...
.DATA
    ...
    WhiteTextOnBlue = black + (yellow * 16)
    ...
    StoredAccountID BYTE "23021519000", 0
    StoredPIN BYTE "1234", 0
    StoredHolderName BYTE "User", 0
    StoredCNIC BYTE "35101-0000000-1", 0
    StoredNO BYTE "0300-1122334", 0
    StoredCity BYTE "Gujranwala"
    StoredMail BYTE "user@example.com", 0
    gender BYTE "M", 0
